...
void GameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->levelCompleted((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->levelFailed(); break;
        case 2: _t->onHeroClicked((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->onBarStopped((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (GameWidget::*)(int );
            if (_q_method_type _q_method = &GameWidget::levelCompleted; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_q_method_type _q_method = &GameWidget::levelFailed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void GameWidget::levelCompleted(int _t1)
{
